...
$(function () {
    ...
    ListJump(".editGRXX",count,'editPersonalInformation');
    ListJump(".editQZYX",count,'editCareerObjective');
    ListJump(".editJYBJ",count,'editEducationBackground');
    ListJump(".editGZJY",count,'editWorkExperience');
